document.addEventListener("DOMContentLoaded", function () {
    ...
    const events = [
      ...
      },
      {
        name: "Stay awake",
        department: "Worship Team",
        date: new Date(2025, 6, 12, 22, 0)
      },
      {
        name: "All day @ Church",
        department: "Intercessors",
        date: new Date(2025, 6, 26, 9, 0)
      },
      {
        name: "Concert",
        department: "Worship Team",
        date: new Date(2025, 8, 6, 18, 0)
      },
      {
        name: "Combined Service with Youth",
        department: "Evangelism",
        date: new Date(2025, 8, 12, 0, 0)
      },
      {
        name: "Prayer day - Come pray for your family",
        department: "Intercessors",
        date: new Date(2025, 8, 20, 9, 0)
      },
      {
        name: "Heritage day Celebration",
        department: "Church",
        date: new Date(2025, 8, 24, 0, 0)
      },
      {
        name: "Breast Cancer Awareness",
        department: "Womens Ministry",
        date: new Date(2025, 9, 18, 0, 0)
      },
      {
        name: "Banquet",
        department: "Church",
        date: new Date(2025, 10, 8, 0, 0)
      },
      {
        name: "Carols By Candle Light",
        department: "Church",
        date: new Date(2025, 11, 14, 0, 0)
      },
      {
    ...
    // ⏱️ Initial call + update every minute
    updateCountdown();
